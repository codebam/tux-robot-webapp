/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cad390b6e61afe3d433044ad18d25042)
// Runtime types generated with workerd@1.20260515.1 2025-06-04 nodejs_compat
interface __BaseEnv_Env {
	CONVERSATION_HISTORY: KVNamespace;
	R2: R2Bucket;
	AI: Ai;
	AI_WORKFLOW: Fetcher /* tux-robot-dev */ | Fetcher /* tux-robot */;
}
declare namespace Cloudflare {
	interface PreviewEnv {
		...
		R2: R2Bucket;
		AI: Ai;
		AI_WORKFLOW: Fetcher /* tux-robot-dev */;
	}
